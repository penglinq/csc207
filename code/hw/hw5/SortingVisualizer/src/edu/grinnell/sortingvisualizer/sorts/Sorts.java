...
public class Sorts {
	...
	public static <T extends Comparable<T>> LinkedList<SortEvent<T>> mergeSort(T[] arr) {
	...
	public static <T extends Comparable<T>> LinkedList<SortEvent<T>> quickSort(T[] arr) {
